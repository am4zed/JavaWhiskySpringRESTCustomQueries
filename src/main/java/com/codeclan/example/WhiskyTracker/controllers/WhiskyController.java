...
public class WhiskyController {
    ...
    public List<Whisky> findWhiskiesByDistilleryAndAge(@PathVariable String distilleryName, @PathVariable int age){
        return whiskyRepository.findWhiskiesByDistilleryAndAge(distilleryName, age);
    }
